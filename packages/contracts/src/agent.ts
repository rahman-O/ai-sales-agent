...
/** P10 tools — opt-in via new AgentConfig allowlist; never silently granted to old ACTIVE configs. */
export const P10_TOOL_NAMES = [
  'scheduleLeadFollowUp',
  'cancelFollowUp',
  'getFollowUps',
] as const;

export type P10ToolName = (typeof P10_TOOL_NAMES)[number];
